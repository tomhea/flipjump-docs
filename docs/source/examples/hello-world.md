...
[View on GitHub](https://github.com/tomhea/flipjump/blob/main/programs/print_tests/hello_world.fj). (The literal smiley `(:` at the end matches the upstream example — feel free to drop it for your own version.)
...
[View on GitHub](https://github.com/tomhea/flipjump/blob/main/programs/print_tests/hello_world_with_str.fj).
