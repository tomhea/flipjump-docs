...
A short tour of real FlipJump programs. Each links to the upstream source in the [`tomhea/flip-jump`](https://github.com/tomhea/flip-jump/tree/main/programs) repo's `programs/` directory — paste any of them into the [IDE](https://fj.tomhe.app) to try them in seconds.
